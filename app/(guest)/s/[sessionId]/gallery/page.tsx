        ...
        <CardHeader>
          ...
          <CardDescription>
            {data.visibility.galleryUnlocked
              ? "You unlocked full gallery access and can now view all session photos."
              : `Take ${missingShots} more shot${missingShots === 1 ? "" : "s"} to unlock all session photos.`}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {data.photos.length === 0 && (
            <p className="text-sm text-muted-foreground">
              No photos yet. Start snapping and check back in a moment.
            </p>
          )}
